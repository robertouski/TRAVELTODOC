...
module.exports = agents = {
  ...
  // URUGUAY 
  agent_uruguay_bariatrica: createAgentConfig(
    "Uruguay",
    "Cirugía Bariátrica",
    prompt_1
  ),
  agent_uruguay_aumento_mamario: createAgentConfig(
    "Uruguay",
    "Aumento Mamario",
    prompt_2
  ),
  agent_uruguay_levantamiento_mamario: createAgentConfig(
    "Uruguay",
    "Levantamiento Mamario",
    prompt_3
  ),
  agent_uruguay_reduccion_mamaria: createAgentConfig(
    "Uruguay",
    "Reducción Mamaria",
    prompt_4
  ),
  ...
  //  CHILE
  agent_chile_bariatrica: createAgentConfig(
    "Chile",
    "Cirugía Bariátrica",
    prompt_5
  ),
  ...
  agent_bolivia_bariatrica: createAgentConfig(
    "Bolivia",
    "Cirugía Bariátrica",
    prompt_9
  ),
  agent_bolivia_aumento_mamario: createAgentConfig(
    "Bolivia",
    "Aumento Mamario",
    prompt_10
  ),
  agent_bolivia_levantamiento_mamario: createAgentConfig(
    "Bolivia",
    "Levantamiento Mamario",
    prompt_11
  ),
  agent_bolivia_reduccion_mamaria: createAgentConfig(
    "Bolivia",
    "Reducción Mamaria",
    prompt_12
  ),
  ...
  // PARAGUAY
  agent_paraguay_bariatrica: createAgentConfig(
    "Paraguay",
    "Cirugía Bariátrica",
    prompt_13
  ),
  agent_paraguay_aumento_mamario: createAgentConfig(
    "Paraguay",
    "Aumento Mamario",
    prompt_14
  ),
  agent_paraguay_levantamiento_mamario: createAgentConfig(
    "Paraguay",
    "Levantamiento Mamario",
    prompt_15
  ),
  agent_paraguay_reduccion_mamaria: createAgentConfig(
    "Paraguay",
    "Reducción Mamaria",
    prompt_16
  ),
